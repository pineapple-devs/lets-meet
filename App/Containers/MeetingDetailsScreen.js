...
import { ScrollView, Text, TouchableHighlight, View, Alert } from 'react-native'
...
class MeetingDetailsScreen extends React.Component {
  ...
  showAlert () {
    Alert.alert('Are you sure you want to delete this meeting?', '',
      [ {text: 'Cancel', onPress: () => NavigationActions.pop, style: 'cancel'},
    ...
    return (
      <View style={{flex: 1}}>
        ...
        <View style={styles.footer}>
          ...
          >
            <Icon name='edit' size={35} color='#004c40' style={{alignSelf: 'flex-end'}} />
          </TouchableHighlight>
...
const mapDispatchToProps = dispatch => {
  return {
    fetchMeetings: (userId, meetingId) => dispatch(InvitationActions.fetchSentInvitationsByMeeting(userId, meetingId))
  }
}
export default connect(mapStateToProps, mapDispatchToProps)(MeetingDetailsScreen)
